...
REM
REM Generated by Vivado on Tue Jan 11 15:00:15 +0530 2022
...
echo "xvlog --incr --relax -prj Univ_shift_reg_TB_vlog.prj"
call xvlog  --incr --relax -prj Univ_shift_reg_TB_vlog.prj -log xvlog.log
